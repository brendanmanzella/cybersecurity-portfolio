...
Transitioning from IT Support to SOC Analyst / Cloud Security | BS Cybersecurity | Sec+ | CCSK v5

---

## Featured Projects

### [Home SOC Lab – Wazuh SIEM](home-soc-lab-wazuh/)
...
CloudTrail log analysis, GuardDuty threat detection, and IAM hardening lab using AWS free tier.

**Tools:** AWS CloudTrail, GuardDuty, IAM, S3
...
IT support professional building security skills through hands-on labs. Experienced with endpoint support, user access management, and basic incident handling. Targeting SOC Analyst (L1) or cloud security support roles.
