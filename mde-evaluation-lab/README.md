...
3. Check the **Action center** for pending or completed remediation actions
...
Navigate to **Advanced hunting** in the portal and run the queries saved in [`queries/threat-hunting.kql`](queries/threat-hunting.kql).
...
See [`incidents/incident-01-ransomware.md`](incidents/incident-01-ransomware.md) for the full structured incident report.
